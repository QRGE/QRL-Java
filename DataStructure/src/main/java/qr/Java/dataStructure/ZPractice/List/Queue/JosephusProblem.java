package qr.Java.dataStructure.ZPractice.List.Queue;
...
public class JosephusProblem<E> extends AbstractList<E> {
    ...
    public E remove(Node<E> node){
        Node<E> prevNode = node.prev;  // 获取被删除的头节点的前一个节点prevNode
        Node<E> nextNode = node.next;  // 获取被删除的头节点的有一个节点nextNode
        ...
        E oldElement = node.element;   // 获取被删除节点的element, 用于返回
