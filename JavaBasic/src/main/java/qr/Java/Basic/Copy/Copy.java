...
public class Copy {
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        System.out.println(d2==d1); // 克隆后的两个对象是不同的
        System.out.println(d1.getBirthday() == d2.getBirthday()); // 对于引用类型采用的策略是指向同一个引用, 所以此处结果为true

        CloneModel2 d3 = new CloneModel2(3, "doctor3", new Date());
        CloneModel2 d4 = d3.clone();
        System.out.println(d3==d4);
        System.out.println(d3.getBirthday() == d4.getBirthday()); // 此处即为false
